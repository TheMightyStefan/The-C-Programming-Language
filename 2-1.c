...
int main ()
{
	...
	printf("INT : -%f     -----     %f\n", pow (2.0, (sizeof(int) * 8) - 1), pow (2.0, (sizeof(int) * 8) - 1) - 1);
        printf("SIGNED LONG : %d     -----     %f\n", 0, pow (2.L, (sizeof(signed long) * 8)));
        printf("SIGNED LONG LONG : %d     -----     %f\n", 0, pow (2.L, (sizeof(signed long long) * 8)));
	printf("UNSIGNED LONG : -%f   -----     %f\n", pow (2.L, (sizeof(unsigned long) * 8) - 1), pow (2.L, (sizeof(unsigned long) * 8) - 1) - 1);
	printf("UNSIGNED LONG LONG : -%f     -----     %f\n", pow (2.L, (sizeof(unsigned long long) * 8) - 1), pow (2.L, (sizeof(unsigned long long) * 8) - 1) - 1);
	return 0;
}  
